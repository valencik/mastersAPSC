...
``` {#rawNSRentry .raw caption="An example NSR entry showing the raw NSR data format."}
<KEYNO   >1988AB01                                                              &
...
``` {#rawNSRJSON .json caption="An example NSR entry showing the final NSR JSON structure."}
{
  "_id": "1988AB01",
  "year": 1988,
  "history": [
